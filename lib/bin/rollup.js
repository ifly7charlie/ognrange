...
import { ROLLUP_PERIOD_MINUTES, MAX_SIMULTANEOUS_ROLLUPS, STATION_EXPIRY_TIME_SECS, MAX_STATION_DBS,
...
function produceStationFile( stations ) {
	...
	let statusOutput = _filter( stations, (v) => {return v.valid && v.lastPacket});
