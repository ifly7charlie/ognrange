...
export const APRS_KEEPALIVE_PERIOD_MS = (process.env.APRS_KEEPALIVE_PERIOD_SECONDS||45) * 1000;
...
export const ELEVATION_TILE_EXPIRY_HOURS = parseInt(process.env.ELEVATION_TILE_EXPIRY_HOURS)||(7*12);
