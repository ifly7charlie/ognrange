...
doCRTest({name: 'one entry', type: bufferTypes.station, inputs: [[10, 11, 1, 12, 0]], output: {MinAlt: 10, MinAltMaxSig: 12, MinAltAgl: 11, SumSig: 12 >> 2, SumCrc: 1, Count: 1, SumGap: 0, NumStations: undefined}});
...
doCRTest({name: 'A', type: bufferTypes.global, inputs: [[10, 11, 1, 12, 0, 1]], output: {MinAlt: 10, MinAltMaxSig: 12, MinAltAgl: 11, SumSig: 12 >> 2, SumCrc: 1, Count: 1, SumGap: 0, NumStations: 1}});

doCRTest({name: 'B', type: bufferTypes.global, inputs: [[10, 11, 1, 12, 0, 1]], output: {MinAlt: 10, MinAltMaxSig: 12, MinAltAgl: 11, SumSig: 12 >> 2, SumCrc: 1, Count: 1, SumGap: 0, 'Station:0': {MinAlt: 10, Count: 1, MinAltMaxSig: 12}, NumStations: 1}});
...
doCRTest({
    ...
    output: {MinAlt: 10, MinAltMaxSig: 12, MinAltAgl: 11, SumSig: (12 >> 2) * 2, SumCrc: 2, Count: 2, SumGap: 0, 'Station:0': {MinAlt: 10, Count: 2, MinAltMaxSig: 12, StationId: 1}, NumStations: 1}
});
...
doCRTest({
    ...
    output: {MinAlt: 10, MinAltMaxSig: 12, MinAltAgl: 11, SumSig: (12 >> 2) * 2, SumCrc: 2, Count: 2, SumGap: 0, 'Station:0': {MinAlt: 10, Count: 1, MinAltMaxSig: 12, StationId: 1}, 'Station:1': {MinAlt: 10, Count: 1, MinAltMaxSig: 12, StationId: 2}, NumStations: 2}
});
...
doCRTest({
    ...
    output: {MinAlt: 10, MinAltMaxSig: 12, MinAltAgl: 11, SumSig: (12 >> 2) * 3, SumCrc: 3, Count: 3, SumGap: 0, 'Station:0': {MinAlt: 10, Count: 2, MinAltMaxSig: 12, StationId: 1}, 'Station:1': {MinAlt: 10, Count: 1, MinAltMaxSig: 12, StationId: 2}, NumStations: 2}
});
...
doCRTest({
    ...
    output: {MinAlt: 10, MinAltMaxSig: 12, MinAltAgl: 11, SumSig: (12 >> 2) * 3, SumCrc: 3, Count: 3, SumGap: 0, 'Station:0': {MinAlt: 10, Count: 2, MinAltMaxSig: 12, StationId: 2}, 'Station:1': {MinAlt: 10, Count: 1, MinAltMaxSig: 12, StationId: 1}, NumStations: 2}
});
...
doRollupTest({name: 'A', src: {type: bufferTypes.global, inputs: [[10, 11, 1, 12, 0, 1]]}, dest: {type: bufferTypes.global, inputs: [[10, 11, 1, 12, 0, 1]]}, validStations: validStations1, output: {MinAlt: 10, MinAltMaxSig: 12, MinAltAgl: 11, SumSig: (12 >> 2) * 2, SumCrc: 2, Count: 2, SumGap: 0, 'Station:0': {MinAlt: 10, Count: 2, MinAltMaxSig: 12, StationId: 1}, NumStations: 1}});
...
doRollupTest({
    ...
    dest: {type: bufferTypes.global, inputs: [[10, 11, 1, 12, 0, 2]]},
...
doRollupTest({
    ...
    dest: {type: bufferTypes.global, inputs: [[10, 11, 1, 12, 0, 3]]},
    validStations: validStations12,
    output: {MinAlt: 10, MinAltMaxSig: 12, MinAltAgl: 11, SumSig: (12 >> 2) * 4, SumCrc: 4, Count: 4, SumGap: 0, 'Station:0': {MinAlt: 10, Count: 2, MinAltMaxSig: 12}, 'Station:1': {MinAlt: 10, Count: 2, MinAltMaxSig: 12}, NumStations: 2}
});
...
doRollupTest({
    ...
    dest: {type: bufferTypes.global, inputs: [[10, 11, 1, 12, 0, 3]]},
    validStations: validStations12,
    output: {SumCrc: 5, Count: 5, SumGap: 0, 'Station:0': {MinAlt: 10, Count: 3, MinAltMaxSig: 12, StationId: 1}, 'Station:1': {MinAlt: 10, Count: 2, MinAltMaxSig: 12, StationId: 2}, NumStations: 2}
});
...
doRollupTest({
    ...
    validStations: validStations1,
    output: {MinAlt: 10, MinAltMaxSig: 12, MinAltAgl: 11, SumSig: 12 >> 2, SumCrc: 1, Count: 1, SumGap: 0, 'Station:0': {MinAlt: 10, Count: 1, MinAltMaxSig: 12, StationId: 1}, NumStations: 1}
});
...
doRollupTest({
    ...
    output: {MinAlt: 9, MinAltMaxSig: 20, MinAltAgl: 10, SumSig: 20 >> 2, SumCrc: 2, Count: 1, SumGap: 1, 'Station:0': {MinAlt: 9, Count: 1, MinAltMaxSig: 20, StationId: 2}, NumStations: 1}
});
...
doRollupTest({
    ...
    validStations: validStations12,
    output: {MinAlt: 10, MinAltMaxSig: 12, MinAltAgl: 11, SumSig: (12 >> 2) * 2, SumCrc: 2, Count: 2, SumGap: 0, 'Station:0': {MinAlt: 10, Count: 1, MinAltMaxSig: 12, StationId: 1}, NumStations: 2}
});
...
doRollupTest({name: 'A', src: {type: bufferTypes.station, inputs: [[10, 11, 1, 12, 0]]}, dest: {type: bufferTypes.station, inputs: [[10, 11, 1, 12, 0]]}, validStations: validStations1, output: {MinAlt: 10, MinAltMaxSig: 12, MinAltAgl: 11, SumSig: (12 >> 2) * 2, SumCrc: 2, Count: 2, SumGap: 0, NumStations: undefined}});

//	update( altitude, agl, crc, signal, gap, stationid ) {
doRollupTest({name: 'B', src: {type: bufferTypes.station, inputs: [[10, 11, 1, 12, 1]]}, dest: {type: bufferTypes.station, inputs: [[5, 10, 2, 8, 1]]}, validStations: validStations1, output: {MinAlt: 5, MinAltMaxSig: 8, MinAltAgl: 10, SumSig: (12 >> 2) + (8 >> 2), SumCrc: 3, Count: 2, SumGap: 2, NumStations: undefined}});

doRollupTest({name: 'C', src: {type: bufferTypes.station, inputs: [[10, 11, 1, 12, 1]]}, dest: {type: bufferTypes.station, inputs: [[10, 10, 2, 8, 1]]}, validStations: validStations1, output: {MinAlt: 10, MinAltMaxSig: 12, MinAltAgl: 10, SumSig: (12 >> 2) + (8 >> 2), SumCrc: 3, Count: 2, SumGap: 2, NumStations: undefined}});

doRollupTest({name: 'D', src: {type: bufferTypes.station, inputs: [[10, 11, 1, 12, 1]]}, dest: {type: bufferTypes.station, inputs: [[10, 10, 2, 24, 1]]}, validStations: validStations1, output: {MinAlt: 10, MinAltMaxSig: 24, MinAltAgl: 10, SumSig: (12 >> 2) + (24 >> 2), SumCrc: 3, Count: 2, SumGap: 2}});
...
test('CoverageHeader set from Buffer', (t) => {
    ...
    t.is(l.h3, '87088619affffff');
    t.not(r.h3, '87088619affffff'); // not valid as we passed a lockKey not a dbKey
    t.deepEqual(l.h3splitlong, h3IndexToSplitLong(l.h3));
    t.deepEqual(l.h3splitlong, [0x9affffff, 0x8708861]);
